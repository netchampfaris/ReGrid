...
var DataTable = function () {
  ...
  _createClass(DataTable, [{
    ...
    value: function setupHeader() {
      this.header = new _Header2.default(this.wrapper.find('.data-table-header'), this.data.columns);
    }
  }, {
    key: 'renderBody',
...
var Header = function () {
  function Header(wrapper, columns) {
  ...
  _createClass(Header, [{
    key: 'render',
    value: function render() {
      this.wrapper.html((0, _utils.getHeaderHTML)(this.columns));
    }
  }, {
    key: 'bindEvents',
    value: function bindEvents() {
