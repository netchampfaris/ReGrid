...
var ReGrid = function () {
  ...
  _createClass(ReGrid, [{
    ...
    value: function onScrollProgress(progress) {
      var dataScrolled = this.dataAppended * (progress / 100);
    ...
    key: 'appendNextPage',
    value: function appendNextPage() {
      var rows = this.data.rows.slice(this.start, this.end);
    ...
    value: function refreshCell(cell) {
      ...
      var $newCell = (0, _jQuery2.default)((0, _utils.getColumnHTML)(cell));
